...
public class LetterProperties {
	...
	public static void registerModel(Item item, IModelManager manager) {
		...
		for (int i = 0; i < 3; i++) {
			models[i][0] = new ModelResourceLocation("mail:mail/letter." + i + ".fresh", "inventory");
			ModelBakery.registerItemVariants(item, new ResourceLocation("mail:mail/letter." + i + ".fresh"));
			models[i][1] = new ModelResourceLocation("mail:mail/letter." + i + ".stamped", "inventory");
			ModelBakery.registerItemVariants(item, new ResourceLocation("mail:mail/letter." + i + ".stamped"));
			models[i][2] = new ModelResourceLocation("mail:mail/letter." + i + ".opened", "inventory");
			ModelBakery.registerItemVariants(item, new ResourceLocation("mail:mail/letter." + i + ".opened"));
			models[i][3] = new ModelResourceLocation("mail:mail/letter." + i + ".emptied", "inventory");
			ModelBakery.registerItemVariants(item, new ResourceLocation("mail:mail/letter." + i + ".emptied"));
		}
