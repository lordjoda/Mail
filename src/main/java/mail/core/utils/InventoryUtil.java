...
import mail.core.inventory.ItemHandlerInventoryManipulator;
import mail.core.inventory.StandardStackFilters;
import mail.core.tiles.AdjacentTileCache;
...
//		}
	...
	public static int addStack(IInventory inventory, ItemStack stack, int startSlot, int slots, boolean doAdd) {
		...
		for (int i = startSlot; i < startSlot + slots; i++) {
			...
			// Already occupied by different items, skip this slot.
