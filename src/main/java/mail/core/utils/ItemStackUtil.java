...
public abstract class ItemStackUtil {
	...
	/**
	 * Compares items id, damage and NBT. Accepts wildcard damage.
	 */
	...
	/**
	 * @return The registry name of the items as {@link ResourceLocation}
	 */
	@Nullable
	...
	/**
	 * @return The registry name of the items as {@link String}
	 */
	@Nullable
	...
	/**
	 * @param itemName The registry name from the items as {@link String}
	 * @return The items from the items registry
	 */
	@Nullable
	...
	/**
	 * @param itemName The registry name from the items as {@link ResourceLocation}
	 * @return The items from the items registry
	 */
	@Nullable
	...
	/**
	 * Compare two items stacks for crafting equivalency without oreDictionary or craftingTools
	 */
	...
	/**
	 * Compare two items stacks for crafting equivalency.
	 */
