...
import mail.api.core.IItemModelRegister;
import mail.api.core.IModelManager;
import mail.api.core.IStateMapperRegister;
import mail.core.blocks.IColoredBlock;
import mail.core.config.Constants;
import mail.core.items.IColoredItem;
import mail.core.utils.ItemStackUtil;
import mail.core.utils.ModelUtil;
...
public class ModelManager implements IModelManager {
	...
	public void onBakeModels(ModelBakeEvent event) {
		...
		//load default items and block model states
		defaultItemState = ModelUtil.loadModelState(new ResourceLocation("minecraft:models/items/generated"));
