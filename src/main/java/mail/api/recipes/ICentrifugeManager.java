...
public interface ICentrifugeManager extends ICraftingProvider<ICentrifugeRecipe> {
	 ...
	 *
	 * @param timePerItem Time to centrifugate one items of the given type. Default is 20.
	 * @param input       ItemStack containing information on items id and damage. Stack size will be ignored.
