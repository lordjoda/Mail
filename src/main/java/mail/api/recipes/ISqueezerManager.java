 ...
 * <p>
 * The manager is initialized at the beginning of BungeeMail's BaseMod.load() cycle. Begin adding recipes in BaseMod.ModsLoaded() and this shouldn't be null even
 * if your mod loads before BungeeMail.
 * <p>
...
public interface ISqueezerManager extends ICraftingProvider<ISqueezerRecipe> {
	 ...
	 * @param resources   Array of items stacks representing the required resources for one process. Stack size will be taken into account.
	 ...
	 *
	 * @param timePerItem Number of work cycles required to squeeze one set of resources.
	 * @param resources   items stack representing the required resources for one process. Stack size will be taken into account.
	 * @param liquid      {@link FluidStack} representing the output of this recipe.
	 * @param remnants    Item stack representing the possible remnants from this recipe. May be empty.
	 * @param chance      Chance remnants will be produced by a single recipe cycle, from 0 to 100.
	 */
